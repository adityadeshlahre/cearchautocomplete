...
```bash
bun create next-app -e "https://github.com/adityadeshlahre/cearchautocomplete" <project-name>

npx create-next-app -e "https://github.com/adityadeshlahre/cearchautocomplete" <project-name>
```
...
```bash
degit adityadeshlahre/cearchautocomplete <project-name>
# using GH cli
gh repo create <project-name> --template <adityadeshlahre>/<cearchautocomplete> --public
